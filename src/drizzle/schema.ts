import { pgTable, foreignKey, bigserial, bigint, text, jsonb, timestamp, check, integer, numeric, index, boolean, uniqueIndex, primaryKey, pgEnum } from "drizzle-orm/pg-core"
...
export const videos = pgTable("videos", {
	...
	index("videos_not_hidden_recent_idx").using("btree", table.createdAt.desc().nullsFirst().op("timestamptz_ops")).where(sql`(hidden = false)`),
